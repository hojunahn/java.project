package 필드연습;
// 필드란? : 클래스 내부에 선언된 변수를 의미합니다. 즉, 클래스로 생성된 각각의 객체마다 별도의 값을 저장하는 용도
...
// 필드의 값을 읽고 쓰기 위해서 게터와 세터를 만들어 주는 것이 일반적인 문법(스트링부트에서 롬복 사용으로 대체 가능)

public class FieldEx {
    public static void main(String[] args) {
        int localVal = 30; // 지역변수, stack 영역에 생성됨, {}범위 내에서만 생존 함, 초기화 되지 않음
